...
\label{sec:validatie}
Het finale model wordt gevalideerd op een aparte testset die gaandeweg is samengesteld. De prestaties worden kwantitatief geëvalueerd via relevante metrieken: de MAE en MAPE voor de vluchttijd, en de accuracy en F1-score voor de horizontale verplaatsing.
